...
**Current position:** **E20 S20.1 landing-page narrative and brand treatment complete** — static landing page awaiting review; next: S20.2 responsive/accessible implementation
...
| npm package publish contract                                                      | Complete — E13 S13.1, awaiting review       | `package.json`, `scripts/` |
...
| specwiki.ai landing page (narrative + brand)                                      | Complete — E20 S20.1, awaiting review       | `site/`                    |
...
- [ ] **E13 — Distribution & Publish** — npm, GitHub Actions _(in progress)_
  - [x] S13.1 — npm publish preparation _(review)_
...
| 2026-07-15 | E13 S13.1        | `chore(package): npm publish gate and verify-package flow` — prepublishOnly quality gate via `scripts/prepublish-check.mjs`; local tarball verification via `scripts/verify-package.mjs`; 10 publish-preparation tests; README maintainer section; 373 tests total; repo coverage 95.83%                                          | uncommitted           | test ✓ · lint ✓ · format ✓ · coverage ✓ · typecheck ✓ · build ✓                      |
| 2026-07-16 | E20 S20.1        | `feat(site): landing-page narrative and brand treatment` — new `site/index.html` + `site/assets/landing.css`; exact hero value proposition; problem/approach/outcome narrative; GitHub CTA (owner-confirmed pre-npm); canonical [[specwiki]] wordmark with light/dark tokens and accessible markup; 12 new tests; 385 tests total | uncommitted           | test ✓ · lint ✓ · format ✓ · coverage ✓ · typecheck ✓ · build ✓                      |
