...
| 2026-07-21 | E27 examples     | `content(examples): add Spec Kit sibling + unpublish mycelium` — keep `agent-harness-parcel` hero; add `speckit-harness-parcel`; gallery publishes harness + Spec Kit + BMAD; `unpublished` keeps mycelium local-only                                                                                                                                                                                                        | uncommitted           | test ✓ · lint ✓ · format ✓ · coverage ✓ · typecheck ✓ · build ✓                      |
